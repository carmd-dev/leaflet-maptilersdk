...
function g() {
  e.MaptilerLayer = e.Layer.extend({
    ...
    onAdd: function(t) {
      ...
      t.getPane(i).appendChild(this._container), this._initMaptilerSDK(), this._offset = this._map.containerPointToLayerPoint([0, 0]), t.options.zoomAnimation && e.DomEvent.on(
        t._proxy,
    ...
    _initContainer: function() {
      ...
      const s = this._map.containerPointToLayerPoint([0, 0]).subtract(a);
      e.DomUtil.setPosition(t, this._roundPoint(s));
    },
    _initMaptilerSDK: function() {
      ...
      this.options.geolocate && (delete s.center, delete s.zoom), this._maptilerMap = new o.Map(s), this._maptilerMap.once("load", () => {
        this.fire("ready");
      ...
      e.DomUtil.addClass(r, "leaflet-image-layer"), e.DomUtil.addClass(r, "leaflet-zoom-animated"), this.options.interactive && e.DomUtil.addClass(r, "leaflet-interactive"), this.options.className && e.DomUtil.addClass(r, this.options.className), Object.keys(o.helpers).forEach((n) => {
        this[n] = (p) => o.helpers[n].apply(null, [
          this._maptilerMap,
          p
        ]);
      });
    ...
    _transformGL: function() {
      ...
      i.center = o.LngLat.convert([t.lng, t.lat]), i.zoom = this._map.getZoom() - 1;
    },
    ...
    _animateZoom: function(t) {
      const i = this._map.getZoomScale(t.zoom), a = this._map.getSize().multiplyBy(this.options.padding * i), s = this.getSize()._divideBy(2), r = this._map.project(t.center, t.zoom)._subtract(s)._add(this._map._getMapPanePos().add(a))._round(), n = this._map.project(this._map.getBounds().getNorthWest(), t.zoom)._subtract(r);
  ...
  }, m = e.maptilerLayer, e.MaptilerStyle = {}, Object.keys(o.MapStyle).forEach((t) => {
    e.MaptilerStyle[t] = o.MapStyle[t];
  }), h = e.MaptilerStyle, c = e.MaptilerStyle, e.maptilerStyle = e.MaptilerStyle, e.MaptilerLanguage = {}, Object.keys(o.Language).forEach((t) => {
    e.MaptilerLanguage[t] = o.Language[t];
